        ...
        <div id="carousel-example-generic" class=" col-lg-12 carousel slide container" class="slider" data-ride="carousel"  >
            ...
            <div class="carousel-inner" role="listbox" >
                <div class="item active">
                    <center>
                      <a href="<?php echo URL ?>index.php/inicio/eventosUsuario"> <img class="img-responsive" src="<?php echo URL ?>image/3.jpg" width="1000px" height="390px"> </a>
                    </center>
                ...
                <div class="item">
                    <center>
                      <a href="<?php echo URL ?>index.php/inicio/eventosUsuario"> <img  class="img-responsive" src="<?php echo URL ?>image/1.jpg" width="1000px" height="390px"> </a>
                    </center>
                    <div class="carousel-caption">
                    </div>
                </div>
                <div class="item">
                    <center>
                        <a href="<?php echo URL ?>index.php/inicio/eventosUsuario"><img class="img-responsive" src="<?php echo URL ?>image/2.jpg" width="1000px" height="390px"></a>
                    </center>
                    <div class="carousel-caption">
                    </div>
                </div>
          ...
          <div class="hidden-xs hidden-md">
                <div class="col-sm-9 col-md-4 col-xs-12">
                    <div class="thumbnail">
                        ...
                        <div class="caption">
                            <h3>Cultura</h3>
                            <p><a href="<?php echo URL ?>index.php/inicio/categoriaUsuarioController" class="btn btn-primary" role="button">Ver mas</a></p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-9 col-md-4 col-xs-12">
