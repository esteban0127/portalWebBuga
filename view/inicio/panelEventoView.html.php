  ...
  <div class=" fondo container-fluid">
    <div class="row col-lg-12">
      <CENTER>
        ...
        <div>
          <a href="<?php echo URL ?>index.php/inicio/registroEventoController" type="submit" class="btn btn-success">Nuevo evento</a>
        </div>
        <div class="col-lg-2 col-md-12 col-sm-12 col-xs-12" style="margin-top: 12px">
          <ul class=" menu nav nav-pills nav-stacked">
            ...
            <li role="presentation" ><a href="<?php echo URL ?>index.php/inicio/panelSitioController">Sitios</a></li>
            <li role="presentation" class="active"><a href="<?php echo URL ?>index.php/inicio/panelEventoController">Eventos</a></li>  
          </ul>
        </div>
        <div>
          <table border="1" class=" col-lg-10 table-responsive" style="margin-top: 10px">
            ...
            <tbody>
              <tr>
                <td>Misa de sanación</td>
                <td>
                  <a href="" class="btn btn-warning btn-xs " data-toggle="tooltip" data-placement="bottom" title="Editar evento">Editar evento</a>
                  <a href="" class="btn btn-primary btn-xs " data-toggle="tooltip" data-placement="bottom" title="Desactivar evento">Desactivar evento</a>
                  <a href="" class="btn btn-danger btn-xs" data-toggle="tooltip" data-placement="bottom" title="Eliminar evento">Eliminar evento</a></td>
              </tr>
