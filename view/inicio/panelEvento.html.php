  ...
  <div class=" fondo container-fluid">
    <div class="row col-lg-12">
      <CENTER>
        ...
        <div>
          <a href="#" type="submit" class="btn btn-success">Nuevo evento</a>
        </div>
        <div class="col-lg-2 col-md-12 col-sm-12 col-xs-12" style="margin-top: 12px">
          <ul class=" menu nav nav-pills nav-stacked">
            ...
            <li role="presentation" ><a href="<?php echo $fsConfig->getUrl() ?>index.php/inicio/panelSitio">Sitios</a></li>
            <li role="presentation" class="active"><a href="<?php echo $fsConfig->getUrl() ?>index.php/inicio/panelEvento">Eventos</a></li>  
          </ul>
        </div>
        <div>
