...
if (isset($_SESSION['user']) === FALSE) {
  ...
  <div class="container container-fluid ">
    ...
    <?php endif ?>
    <div class=" fondo hotel container-fluid">
      <div class="row col-lg-12">
        <CENTER>
          <h2>PANEL DE CONTROL</h2>
          <div>
            <a href="" type="submit" class="btn btn-success invisible">Nuevo evento</a>
          </div>
          <div class="col-lg-2 col-md-12 col-sm-12 col-xs-12" style="margin-top: 12px">
            <ul class=" menu nav nav-pills nav-stacked">
              <li role="presentation" class="active"><a href="<?php echo $fsConfig->getUrl() ?>index.php/inicio/panel">Home</a></li>
