  ...
  <div class="hotel">
    ...
    <div class="row">
      <div class="col-sm-8 col-md-4 col-xs-12">
        <img src="<?php echo $fsConfig->getUrl() ?>image/ht1.jpg" width="420px" height="220px" style="margin-left: 10px;margin-bottom: 10px;" class="img-responsive">
      </div>
      <div class="col-sm-6 col-md-8 col-xs-12">
        ...
        <?php if (isset($_SESSION['user']) === true) {
          ?>
          <a href="<?php echo $fsConfig->getUrl() ?>index.php/inicio/itine"  type="submit" class="btn btn-info">Agregar a itinerario</a>
        <?php } ?>
      </div>
    </div>
  </div>
        ...
        <ul id="comments-list" class="comments-list">
          <li>
            <div class="comments-main-level">
              ...
              <div class="comments-avatar"><img src="<?php echo $fsConfig->getUrl() ?>image/ww.jpg" alt=""></div>  
            ...
            <ul class="comments-list reply-list">
              <li>
                ...
                <div class="comments-avatar"><img src="<?php echo $fsConfig->getUrl() ?>image/qq.jpg" alt=""></div>  
                <div class="comment-box">
                  <div class="comments-head">
