  ...
  <div class="catego">
      ...
      <div style="margin-top:30px; " class="row">
        <div class="col-sm-8 col-md-6">
            <a href="<?php echo URL ?>index.php/inicio/sitioUsuarioController"> <img src="<?php echo URL ?>image/cat2.jpg" width="400px" height="210px" style="margin-left: 10px;margin-bottom: 10px;" class="img-responsive"></a>
        </div>
        <div class="col-sm-8 col-md-4">
          <a class="cat1" href="<?php echo URL ?>index.php/inicio/sitioUsuarioController">TEATRO MUNICIPAL ERNESTO SALCEDO OSPINA</a>
      ...
      <div style="margin-top:30px; " class="row">
        <div class="col-sm-8 col-md-6">
            <a href="<?php echo URL ?>index.php/inicio/sitioUsuarioController">  <img src="<?php echo URL ?>image/cat3.jpg" width="400px" height="210px" style="margin-left: 10px;margin-bottom: 10px;" class="img-responsive"></a>
        </div>
        <div class="col-sm-8 col-md-4">
          <a class="cat1" href="<?php echo URL ?>index.php/inicio/sitioUsuarioController">CASA DE LA CULTURA</a>
          <p>Por su arquitectura colonial californiana, el Hotel Guadalajara es considerado patrimonio arquitectónico del Departamento del Valle del Cauca, por lo que es punto de encuentro y sitio obligado de visita para todos los vallecaucanos. Ideal para vacaciones, recreación, negocios o sencillamente para buscar paz y tranquilidad.</p>
        </div>
      </div>
    </div>
